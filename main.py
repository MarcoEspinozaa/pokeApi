...
#Obtener Peso
peso = pokemon['weight'] #--> Variable $peso a modificar html base
#Etapa previa en caso de tener
etapaPrevia = preview(especiePokemon)
htmlPreview = f'Etapa previa: {etapaPrevia}' #--> Variable $htmlPreview a modificar html base
